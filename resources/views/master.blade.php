...
<head>
  ...
  <title>@yield('title')</title>
    {{--<link rel="stylesheet" href="//cdn.staticfile.org/weui/0.4.3/style/weui.css">--}}
    <link rel="stylesheet" href="/css/weui.css"onclick="history.go(-1)">
    <link rel="stylesheet" href="/css/book.css" onclick="onMenuClick();">
</head>
<body>
