    ...
    <form action="" method="post" class="form form-horizontal" id="form-product-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-8">
                <script id="editor" type="text/plain" style="width:100%; height:400px;"></script><img/>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-2">产品图片：</label>
            <div class="formControls col-8">
                <img src="/admin/images/icon-add.png" id="preview_id1" style="border: 1px solid #B8B9B9; width: 100px; height: 100px;" onclick="$('#input_id1').click();" />
                ...
                <img src="/admin/images/icon-add.png" id="preview_id2" style="border: 1px solid #B8B9B9; width: 100px; height: 100px;" onclick="$('#input_id2').click();" />
                ...
                <img src="/admin/images/icon-add.png" id="preview_id3" style="border: 1px solid #B8B9B9; width: 100px; height: 100px;" onclick="$('#input_id3').click();" />
                ...
                <img src="/admin/images/icon-add.png" id="preview_id4" style="border: 1px solid #B8B9B9; width: 100px; height: 100px;" onclick="$('#input_id4').click();" />
                ...
                <img src="/admin/images/icon-add.png" id="preview_id5" style="border: 1px solid #B8B9B9; width: 100px; height: 100px;" onclick="$('#input_id5').click();" />
        ...
        <div class="row cl">
            <div class="col-8 col-offset-2">
                <input type="submit" class="btn btn-primary radius" style="margin: 20px;" value="&nbsp;&nbsp;提交&nbsp;&nbsp;">
            </div>
        </div>
    </form>
@endsection
